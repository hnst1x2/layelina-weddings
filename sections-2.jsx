...
function Calendar({ bookings: fallbackBookings }) {
  ...
  // Fetch bookings from Supabase on mount (read-only — admin manages writes via Supabase dashboard)
  useEffect2(() => {
    if (!sbReady) return;
    let cancelled = false;
    (async () => {
    ...
    <section className="calendar" id="calendar">
      <div className="container">
        <div className="section-head">
          ...
          <p>Consultez les créneaux libres et contactez-nous pour la date qui vous convient.</p>
        </div>

        <div className="calendar-wrap">
          <div className="calendar-info">
            <h3>Vérifiez les <span className="accent">disponibilités</span></h3>
            <p>Cliquez sur une date libre pour la sélectionner, puis contactez-nous pour confirmer la réservation. Les week-ends de haute saison (mai à septembre) se réservent rapidement.</p>
